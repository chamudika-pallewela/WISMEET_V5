...
import { useGetDatabaseRecordings } from "@/hooks/useGetDatabaseRecordings";
...
const Home = () => {
  ...
  } = useGetDatabaseMeetings();
  const { recordings, isLoading: recordingsLoading } = useGetDatabaseRecordings(
    user?.id ?? ""
  );
  ...
  console.log(
    "🔍 Home Debug - upcomingMeetings length:",
          ...
          const invitationResponse = await fetch(
            "/api/meetings/send-invitations",
            {
              ...
              body: JSON.stringify({
                ...
                endTime: new Date(
                  meetingDateTime.getTime() + 60 * 60 * 1000
            ...
            if (invitationResult.statistics) {
              ...
              if (successful > 0) {
                ...
                toast({
                  ...
                  description:
                    "Meeting created successfully, but invitation emails failed to send. Please check your email configuration.",
                  variant: "destructive",
                });
              }
            }
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white p-6 lg:p-8 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">
            Please sign in to access your meetings and recordings.
          </p>
        </div>
      </div>
    );
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                  <div className="space-y-6">
                    ...
                    >
                      Experience seamless video meetings with enterprise-grade
                      security, crystal clear audio, and advanced collaboration
                      tools.
                    </motion.p>
                  </div>
        ...
        <section className="px-6 lg:px-8 py-8 space-y-8">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-400">
                Start or join meetings with enterprise-grade quality
              </p>
            </div>
              ...
              {meetingsLoading ? (
                ...
                <div className="col-span-full flex flex-col items-center justify-center py-12 px-4">
                  ...
                  <p className="text-gray-400 text-center mb-6">
                    You don't have any meetings scheduled. Would you like to
                    schedule one now?
                  </p>
                  <button
          ...
          <div className="mt-12 rounded-2xl bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 border border-gray-800/50">
            <div className="flex items-center justify-between mb-6">
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-400">
                  Your latest meeting recordings
                </p>
              </div>
              <Link
                href="/recordings"
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <h5 className="font-medium text-white">
                          {recording.filename?.substring(0, 40) ||
                            "Recorded Meeting"}
                        </h5>
                        <p className="text-sm text-gray-400">
                          {recording.endedAt &&
                            formatDistanceToNow(new Date(recording.endedAt), {
                              addSuffix: true,
                            })}
                        </p>
                      </div>
